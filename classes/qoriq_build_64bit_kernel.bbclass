...
python () {
    ...
    if promote_kernel == "1":
        sys_multilib = 'powerpc64' + d.getVar('TARGET_VENDOR') + '-' + d.getVar('HOST_OS')
        tc_options = d.getVar('TOOLCHAIN_OPTIONS') + '/../lib64-' + d.getVar("MACHINE")
        d.setVar('DEPENDS_append', ' lib64-gcc-cross lib64-libgcc')
        d.setVar('PATH_append', ':' + d.getVar('STAGING_BINDIR_NATIVE') + '/ppc64e6500-fsl-linux')
